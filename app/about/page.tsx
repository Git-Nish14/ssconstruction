...
export default function AboutUs() {
  return (
    <div className="w-full min-h-screen bg-white  text-gray-900  px-4 py-16 md:px-24 flex items-center justify-center">
      <motion.div
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <span className="text-gray-800">20+ Years of Experience</span>
          </div>
          <div className="flex items-center gap-3">
