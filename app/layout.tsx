...
export const metadata: Metadata = {
  ...
  metadataBase: new URL("https://sindhwaiconstructions.vercel.app"),
  openGraph: {
    ...
    url: "https://sindhwaiconstructions.vercel.app",
    siteName: "Shree Sindhwai Constructions",
    images: [
      {
        url: "https://sindhwaiconstructions.vercel.app/og-image.jpg", // Make sure you upload this
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://sindhwaiconstructions.vercel.app/og-image.jpg"],
  },
  icons: {
    icon: "/favicon.ico",
