...
const Contact: React.FC = () => {
  ...
  const onSubmit = async (event: any) => {
    ...
    const response = await fetch("https://formcarry.com/s/wTCmxgnqqj7", {
      method: "POST",
      body: formData,
      headers: {
  ...
  return (
    <motion.section
      ...
      className="w-full h-screen bg-gray-100 md:py-20 py-7 px-6 sm:px-12 lg:px-32 text-black"
    >
      ...
      <form
        onSubmit={onSubmit}
        className="max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 bg-white p-6 md:p-8 rounded-xl shadow-lg"
      >
        <input
          type="text"
          name="name"
